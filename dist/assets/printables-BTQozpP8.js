import{r as Ne,c as ve,j as n}from"./vendor-react-C-Dg_Q4f.js";import{K as we,f as o,l as ke}from"./pages-invoices-BvIMmSOh.js";const Se={name:"Onelka Jewellery",tagline:"Exquisite Craftsmanship Since 1985",address:"Makandura, Matara.",city:"Matara",phone:"0770400789",email:"onelkajewellery95@gmail.com"},ze=Ne.forwardRef((s,i)=>{const e=ve.c(161),{invoice:t,customer:l,company:je}=s,a=je===void 0?Se:je;let O;e[0]!==t.items?(O=()=>t.items.reduce(_e,0),e[0]=t.items,e[1]=O):O=e[1];const xe=O;let r,c,d,h,m,x,b,f,g,p;if(e[2]!==xe||e[3]!==a.address||e[4]!==a.city||e[5]!==a.email||e[6]!==a.name||e[7]!==a.phone||e[8]!==a.phone2||e[9]!==a.tagline||e[10]!==a.website||e[11]!==l||e[12]!==t.customerAddress||e[13]!==t.customerName||e[14]!==t.customerPhone||e[15]!==t.dueDate||e[16]!==t.invoiceNumber||e[17]!==t.issueDate||e[18]!==t.items||e[19]!==t.status||e[20]!==t.subtotal||e[21]!==i){const ye=xe();f=i,g="print-invoice-a5",e[32]===Symbol.for("react.memo_cache_sentinel")?(p=n.jsx("style",{children:`
          /* =========================================
