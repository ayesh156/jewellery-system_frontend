import{r as De,c as Se,j as t}from"./vendor-react-0ysHbwzk.js";import{K as ze,f as pe,l as Me}from"./pages-invoices-B8P--s7Z.js";const Ae={name:"Onelka Jewellery",tagline:"Exquisite Craftsmanship Since 1985",address:"Makandura, Matara.",city:"Matara",phone:"0770400789",email:"onelkajewellery95@gmail.com"},Re=De.forwardRef((l,n)=>{const e=Se.c(161),{invoice:a,customer:i,company:de}=l,s=de===void 0?Ae:de;let se;e[0]!==a.items?(se=()=>a.items.reduce(Ee,0),e[0]=a.items,e[1]=se):se=e[1];const le=se;let d,r,f,P,c,R,b,k,g,o;if(e[2]!==le||e[3]!==s.address||e[4]!==s.city||e[5]!==s.email||e[6]!==s.name||e[7]!==s.phone||e[8]!==s.phone2||e[9]!==s.tagline||e[10]!==s.website||e[11]!==i||e[12]!==a.customerAddress||e[13]!==a.customerName||e[14]!==a.customerPhone||e[15]!==a.dueDate||e[16]!==a.invoiceNumber||e[17]!==a.issueDate||e[18]!==a.items||e[19]!==a.status||e[20]!==a.subtotal||e[21]!==n){const ee=le();k=n,g="print-invoice-a5",e[32]===Symbol.for("react.memo_cache_sentinel")?(o=t.jsx("style",{children:`
          /* =========================================
